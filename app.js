...
function loadPage27() {
    ...
    fetch("ndf15.csv")
        ...
        .then(data => {
            ...
            html += `<div id="gesamtSumme27" class="gesamt">
                        Gesamtsumme: 0,00 €
                     </div>`;
...
function loadPage28() {
    ...
    fetch("ndf16.csv")
        ...
        .then(data => {
            ...
            html += `<div id="gesamtSumme28" class="gesamt">
                        Gesamtsumme: 0,00 €
                     </div>`;
...
function loadPage30() {
    ...
    fetch("ndf17.csv")
        ...
        .then(data => {
            ...
            html += `<div id="gesamtSumme30" class="gesamt">
                        Gesamtsumme: 0,00 €
                     </div>`;
...
function loadPage31() {
    ...
    fetch("ndf18.csv")
        ...
        .then(data => {
            ...
            html += `<div id="gesamtSumme31" class="gesamt">
                        Gesamtsumme: 0,00 €
                     </div>`;
...
function loadPage32() {
    ...
    fetch("ndf19.csv")
        ...
        .then(data => {
            ...
            html += `<div id="gesamtSumme32" class="gesamt">
                        Gesamtsumme: 0,00 €
                     </div>`;
...
function loadPage13() {
    ...
    fetch("ndf21.csv")
        ...
        .then(data => {
            ...
            html += `<div id="gesamtSumme13" class="gesamt">
                        Gesamtsumme: 0,00 €
                     </div>`;
